...
- `S03-15 Checkpoint-Accelerated Replay`: `In Progress (correctness implemented, benchmark pending)`
- `S03-19 T19-01 Visualization Endpoint`: `Implemented (backend graph endpoint)`
- `S03-17 Branch Merging`: `Planned (later)`
...
| `AB02-T015A` | Checkpoint-Accelerated Replay (Service + Correctness Test) | Implemented (benchmark pending) | `src/nexus_babel/services/evolution.py`, `tests/test_evolution_api.py` |
...
|---|---|---|---|
| `AB02-T015B` | Checkpoint Replay Benchmark (Slow, Non-Gating) | P1 | `S03-15 / T15-03` |
| `AB02-T017` | Branch Merge Primitives + API | P2 | `S03-17 / T17-01..T17-04` |
